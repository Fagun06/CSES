...
void init(ll node,ll b,ll e)///b=begin node,e=end node
{
    ...
    tre[node]=tre[leftnode]^tre[rightnode];///store the value in parent node
}
...
void update(ll node,ll b,ll e,ll i,ll newvalue)///change the value of ith index
{
    ...
    tre[node]=tre[leftnode]^tre[rightnode];///store the value in parent node after the updating new value
}
void solve()
{
